			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<?php
                                                $counter = 0;
                                                $query = "SELECT *, count(book_stat.book_id) as count FROM book_stat LEFT JOIN books ON books.accession_no = book_stat.book_id GROUP BY book_stat.book_id ASC LIMIT 10";
